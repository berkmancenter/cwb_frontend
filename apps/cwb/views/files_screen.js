...
CWB.FilesScreen = SC.WorkspaceView.extend({
  ...
  contentView: SC.SplitView.extend({
    ...
    topLeftView: CWB.SourceView.extend(SC.SplitChild, {
      //contentBinding: 'CWB.foldersController.arrangedObjects',
      //selectionBinding: 'CWB.foldersController.selection'
    }),

    bottomRightView: SC.SplitView.extend(SC.SplitChild, {
      dividerThickness: 1,
      defaultThickness: 0.75,

      topLeftView: SC.WorkspaceView.extend(SC.SplitChild, {
        topToolbar: SC.ToolbarView.extend({
          anchorLocation: SC.ANCHOR_TOP,
      ...
      bottomRightView: SC.WorkspaceView.extend(SC.SplitChild, {
        topToolbar: SC.ToolbarView.extend({
      ...
      })  // bottomRightView: SC.WorkspaceView
